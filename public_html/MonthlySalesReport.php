...
<html lang="en">
    ...
    <main>
      ...
      <header class="header bg-ui-general">
        <div class="header-action">
          <nav class="nav">
            <a class="nav-link " href="MonthlyPurchaseReport.php">Purchase Report</a>
          ...
          <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                      <label class="require">Pick a Month</label>
                      <select data-live-search="true" class="form-control" data-provide="selectpicker"  id="month" name="month" title="Please Select a Month" required>
                      <?php
  for ($i = 0; $i <= 12; ++$i) {
  ...
  ?>
              ...
              <div class="col-sm-2">
                  <div class="form-group">
                    <div class="h-30px"></div>
                      <button class="btn btn-label  btn-primary" onclick="DisplaySalesReportTblDataOnclick()" type="button"><label><i class="ti-search fs-20"></i></label> Submit</button>
                  </div>
              </div>
          </div>
          </form>
    ...
    <!-- Page Script -->
    <script src="../js/MonthlyPurchaseReport.js"></script>
  </body>
</html>
<?php
}
