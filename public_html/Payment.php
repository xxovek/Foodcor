      ...
      <header class="header bg-ui-general">
        <div class="header-action">
          <nav class="nav">
            ...
            <a class="nav-link active" href="#">Payment Transactions</a>
                      ...
                      <div class="flexbox flex-justified text-center bg-white">
                        <div class="no-shrink">
                          <h6>
                            ...
                            <span class="fs-20" >Total Payment Recieved</span><strong> ₹<span class="fs-28 fw-100" style="color: #ff8000" id="totalRevenue"></strong></span>
